...
::: {.column width="25%"}
![](/images/Intro_slides/kids2.jpg){width="450"} ![](/images/Intro_slides/kids3.JPG){width="450"}
:::
:::::::
...
-   Star the class website: <https://jminnier.github.io/BSTA551_26W/>
...
```{=html}
<iframe id="frame" src="https://www.jessicaminnier.com/BSTA551_26W/"></iframe>
```

## Let's visit the website: Syllabus (1/2)

-   Course learning objectives
-   Textbook in print or ebook via library access (different than last year)
-   Resources: Other course sites
