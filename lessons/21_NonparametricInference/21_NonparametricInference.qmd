...
The important relaxation is normality (not all assumptions).
:::
...
p_paired <- sbp_long |>
  ...
  labs(title = "Systolic Blood Pressure Before \nand After Antihypertensive Treatment",
...
p_vio <- tibble(
  ...
  labs(
    ...
    subtitle = "Right-skewed biomarker: Wilcoxon rank-sum preferred.\nDiamond = median.",
    x = NULL, y = "CRP (mg/L)"
  ) +
...
p_ranks <- tibble(CRP = all_crp, Group = all_group,
  ...
  labs(title = "CRP Values vs. Pooled Ranks",
       subtitle = "Infection group tends to hold the higher ranks",
