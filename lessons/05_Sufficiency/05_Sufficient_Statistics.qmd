...
poisson_sim |> 
  ...
  mutate(Estimator = ifelse(Estimator == "crude_U", "Crude: I(X_1=0)", "Improved: (1-1/n)^T")) |> 
...
#| eval: false
#| include: false
decktape reveal --fragments docs/lessons/05_Sufficiency/05_Sufficient_Statistics.html lessons/05_Sufficiency/05_Sufficient_Statistics.pdf
```
