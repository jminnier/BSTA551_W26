---
title: "Lesson 11: Confidence Intervals Continued + Review"
...
# Lesson 11: Confidence Intervals Continued + Review {background-color="#2c3e50"}
...
The **95% Score (Wilson) CI for $p$** is:
...
Simplifying, the **95% Score CI for $\lambda$** is:
$$\left(\frac{X + z^2/2 - z\sqrt{X + z^2/4}}{n}, \; \frac{X + z^2/2 + z\sqrt{X + z^2/4}}{n}\right)$$

Or in terms of $\hat{\lambda} = X/n$:
$$\left(\hat{\lambda} + \frac{z^2}{2n} - \frac{z}{n}\sqrt{n\hat{\lambda} + \frac{z^2}{4}}, \; \hat{\lambda} + \frac{z^2}{2n} + \frac{z}{n}\sqrt{n\hat{\lambda} + \frac{z^2}{4}}\right)$$
...
#| eval: false
#| include: false
decktape reveal --fragments docs/lessons/11_Review_Confidence_Intervals/11_Review_Confidence_Intervals.html lessons/11_Review_Confidence_Intervals/11_Review_Confidence_Intervals.pdf
```
